    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnStudentCommentEvent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(selectedEvent.studentsID == null ||selectedEvent.studentsID.isEmpty()|| !selectedEvent.studentsID.contains(studentID)){
                    if(comment.isEmpty() && rateStr.isEmpty()){
                        ...
                        if(selectedEvent.studentsID == null||selectedEvent.studentsID.isEmpty()){
                            selectedEvent.studentsID = new ArrayList<>();
                        }
                        selectedEvent.studentsID.add(studentID);
                        updateEvent();
